...
<section id="jobs">
  ...
  <div class="subtopic-grid">
    ...
    <div class="card">
      <h3>8 — Electrician</h3>
      <p>Repair broken appliances and devices for a fee. Take it with <code>/getjob 8</code>. You must be driving your Electrician job vehicle (see <code>/joblist</code>) for every repair command below.</p>
      <ul>
...
<section id="factions">
  ...
  <div class="subtopic-grid">
    <div class="card">
      ...
      <h4>Self-surrender — <code>/arrestme</code></h4>
      <p>At the <strong>[ Jail ]</strong> marker, if <strong>no officer is on duty</strong>, a player with wanted level <span class="num">2+</span> can turn themselves in with <code>/arrestme</code>. Same jail time and fine as a normal <code>/arrest</code>, but <span class="num">+20%</span> on both — and since there's no arresting officer, the full fine goes straight into the Police faction vault instead of being split.</p>
    </div>
    <div class="card">
