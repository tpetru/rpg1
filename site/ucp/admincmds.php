...
$ADMIN_COMMANDS = [
    1 => [
        'General' => [
            ...
            ['cmd' => '/clslist', 'desc' => 'Dialog with all in-game created clothing stores (ID, name, interior status), with a teleport button.'],
            ['cmd' => '/hotellist', 'desc' => 'Dialog with all hotels, with a teleport button.'],
            ['cmd' => '/shoplist', 'desc' => 'Dialog with all 24/7 shops, with a teleport button.'],
            ['cmd' => '/fflist (alias /fastfoodlist)', 'desc' => 'Dialog with all fast-food spots, with a teleport button.'],
            ['cmd' => '/interiorlist', 'desc' => 'Category picker, then a dialog of GTA interiors in that category, with a teleport button (also sets the matching interior ID).'],
            ['cmd' => '/ammolist', 'desc' => 'Dialog with all in-game created ammunations (ID, name, interior status), with a teleport button.'],
            ['cmd' => '/cnnlist', 'desc' => 'Dialog with the 3 /ad zone points (ID, zone name, cooldown status), with a teleport button.'],
        ],
    ],
    2 => [
        'General' => [
            ...
            ['cmd' => '/showstats [playerid]', 'desc' => 'Shows you the target\'s full /stats report (account, faction/job, cash/bank/properties, phone, disease/jail/mute, rob points, gas can, watch, admin level).'],
        ...
        'Vehicles' => [
            ...
            ['cmd' => '/givemoney [playerid] [amount]', 'desc' => 'Gives (or removes, with a negative amount) cash to the target, out of nowhere.'],
            ['cmd' => '/setvip [playerid] [0/1]', 'desc' => 'Grants or removes VIP status for the target. Notifies them either way.'],
        ],
    ],
    3 => [
        'General' => [
            ...
            ['cmd' => '/roadworking [nr paydays] [zone name]', 'desc' => 'Creates a temporary road closure: 2 objects (model 4517) 20 units in front of and behind you, facing your direction. Announces the closure server-wide. Auto-clears (and announces reopening) after the given number of PayDays. Only one zone can be active at a time. Use /roadworking -1 to force-clear the active zone immediately.'],
        ],
    ],
    4 => [
        'General' => [
    ...
    5 => [
        'General' => [
            ...
            ['cmd' => '/fc [factionid] spawn', 'desc' => 'Sets interior X/Y/Z, interior ID, virtual world, and facing angle all at once, taken from your current position/state.'],
            ...
            ['cmd' => '/clsc [id] name/loc/int [value]', 'desc' => 'Configures an in-game created clothing store: rename, move to your position, or link an interior (int = gtaIntID).'],
            ['cmd' => '/ammoc [id] name/loc/int [value]', 'desc' => 'Configures an in-game created ammunation: rename, move to your position, or link an interior (int = gtaIntID).'],
            ['cmd' => '/shopc [id] loc/name [value]', 'desc' => 'Configures a shop: move to your position, or rename it.'],
        ],
    ],
    6 => [
        'Create' => [
            ...
            ['cmd' => '/htlc capacity [htlID] [nr]', 'desc' => 'Sets the hotel\'s maximum number of simultaneous renters.'],
            ...
            ['cmd' => '/farmcreate [name]', 'desc' => 'Creates a new farm at your position, default price $10,000,000, range 30 (fails if MAX_FARMS is reached).'],
            ['cmd' => '/createclothstore', 'desc' => 'Creates a clothing store at your position (no map icon).'],
            ['cmd' => '/clothstoredelete [id]', 'desc' => 'Deletes the clothing store with the given ID.'],
            ['cmd' => '/createammunation', 'desc' => 'Creates an ammunation at your position (no map icon).'],
            ['cmd' => '/ammunationdelete [id]', 'desc' => 'Deletes the ammunation with the given ID.'],
            ['cmd' => '/shopcreate', 'desc' => 'Creates a 24/7 shop at your position, default name "24/7 Shop".'],
            ['cmd' => '/shopDelete [id]', 'desc' => 'Deletes the shop with the given ID.'],
        ],
    ],
];
?>
